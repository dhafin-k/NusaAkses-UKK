...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    },
    {
        ...
        href: '/admin/kendaraan/edit'
    }
]

export default function KendaraanEdit({ kendaraan, jenisKendaraan, errors, flash }: Props) {
    ...
    const { data, setData, put, processing } = useForm({
        ...
        jenis_kendaraan_id: kendaraan.jenis_kendaraan_id.toString(),
    });
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        put(`/admin/kendaraan/${kendaraan.id}`, {
            onError: (errors) => {
            ...
            <div className='flex h-full flex-1 flex-col gap-4 rounded-xl p-6 bg-linear-to-br from-background to-muted/20'>
                ...
                <div className='flex items-center justify-between'>
                    <div>
                        ...
                        <p className='text-muted-foreground mt-1'>Isi form berikut untuk merubah data kendaraan</p>
                    </div>
                    <Button
                        variant='outline'
